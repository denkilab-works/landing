...
const projects = {
  web: [
    ...
    },
    {
      ...
      description: "An analytics dashboard for healthcare providers to monitor patient data and outcomes.",
      image: "/placeholder.svg?height=400&width=600",
  ...
  mobile: [
    ...
    },
    {
      ...
      description: "A food delivery platform connecting local restaurants with customers.",
      image: "/placeholder.svg?height=400&width=600",
  ...
  design: [
    {
      ...
      description: "A complete UX/UI overhaul for a financial services platform.",
      image: "/placeholder.svg?height=400&width=600",
      tags: ["Figma", "UI/UX", "Design System"],
    },
    {
      title: "Travel Booking Interface",
      description: "An intuitive booking interface for a travel agency with focus on accessibility.",
      image: "/placeholder.svg?height=400&width=600",
                        ...
                        <CardContent className="p-6">
                          <div className="flex justify-between items-start mb-3">
                            ...
                            <Button variant="ghost" size="icon" asChild>
                              <Link href="#" aria-label={`View ${project.title} project`}>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {project.tags.map((tag, tagIndex) => (
                              <span key={tagIndex} className="text-xs bg-secondary px-2 py-1 rounded-full">
                                {tag}
                              </span>
                            ))}
                          </div>
